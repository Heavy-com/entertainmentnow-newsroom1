// api/news.js — Vercel serverless function with in-memory caching
// Cache lasts 15 minutes — all team members share the same cached result
// reducing NewsAPI usage from 4 requests/load to ~6 requests/day
...
// In-memory cache — persists across requests within the same Vercel function instance
const cache = {};
